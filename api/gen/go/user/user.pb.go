...
const file_api_proto_user_proto_rawDesc = "" +
	"\n" +
	"\x14api/proto/user.proto\x12\x04user\x1a\x1cgoogle/api/annotations.proto\" \n" +
	...
	"\x02id\x18\x01 \x01(\x03R\x02id2\xb4\x01\n" +
	"\vUserService\x12N\n" +
	"\aGetUser\x12\x14.user.GetUserRequest\x1a\x15.user.GetUserResponse\"\x16\x82\xd3\xe4\x93\x02\x10\x12\x0e/v1/users/{id}\x12U\n" +
	"\n" +
	"CreateUser\x12\x17.user.CreateUserRequest\x1a\x18.user.CreateUserResponse\"\x14\x82\xd3\xe4\x93\x02\x0e:\x01*\"\t/v1/usersB#Z!grpc-user-service/api/gen/go/userb\x06proto3"
